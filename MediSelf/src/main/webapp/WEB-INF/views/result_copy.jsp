                                ...
                                <div class="result-block"
                                    ...
                                    <div style="padding: 15px 5px;">
                                        <div class="first">
                                            <div class="side-menu-progress-bar"
                                                style="background-color: #cfd6dd; float: left; width: 82px; height: 4px; border-radius: 5px;margin-left: 1%; overflow:hidden; margin-top: 10px;">
                                            ...
                                            <span style="margin-left: 3%; font-size: 18px;">복막염</span></button>
                                            <hr>
									  ...
									  <div class="modal-dialog" role="document">
									    <div class="modal-content">
									      <div class="modal-header">
									        <h5 class="modal-title" id="exampleModalLabel">복막염</h5>
									      ...
									      <div class="modal-body">
									        <p>
									        	<h1 style="font-size: 24px; color: blue;">추천</h1> 가까운 <strong>소화기 내과</strong>에 진료받으세요.<br>
									        	<h1 style="font-size: 24px; color: blue;">정의</h1> 복막염은 복강 및 복강 내 장기를 덮고 있는 얇은 막인 복막에 생긴 염증을 의미합니다. 주로 복강 속에 장액, 섬유소, 세포, 고름 등이 고이면서 발생합니다. 복막염은 급성 혹은 만성으로 발생할 수 있습니다. 복부 전체에 나타날 수 있으며, 부분적으로 나타날 수도 있습니다.
									        </p>
									      </div>
									    </div>
									  </div>
                                    ...
                                    <div style="padding: 15px 5px;">
                                        <div class="second">
                                            ...
                                            <span style="margin-left: 3%; font-size: 18px;">신종 플루</span>
                                            </button>
                                            <hr>
									...
									<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									  <div class="modal-dialog" role="document">
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <p>
									        	<h1 style="font-size: 24px; color: blue;">추천</h1> 가까운 <strong>감염내과,호흡기내과</strong>에 진료받으세요.<br>
									        	<h1 style="font-size: 24px; color: blue;">정의</h1> 신종 플루는 A형 인플루엔자 바이러스에 감염된 돼지로부터 발생한 신종 인플루엔자 바이러스(pandemic influenza A/H1N1 2009)에 의해 감염되는 호흡기 질환을 의미합니다. 초기에 '돼지 독감'으로 불린 이 바이러스성 질환은 멕시코에서 등장하여 미국으로 퍼진 후 전 세계로 확산되었습니다. 신종 플루의 증상은 계절 인플루엔자와 비슷하여, 발열, 기침, 인후통, 콧물, 두통, 오한, 피로, 오심, 구토가 나타날 수 있습니다.
									        </p>
									      </div>
									    </div>
									  </div>
