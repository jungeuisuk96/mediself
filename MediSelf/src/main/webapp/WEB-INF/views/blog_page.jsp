...
<!-- main css -->
<link rel="stylesheet" href="css/style_blog_page_board.css">
<link rel="stylesheet" href="css/bbpress_page_board.css">
...
<body>
		...
		<div class="banner_inner d-flex align-items-center">
			<div class="container">
				<div class="banner_content text-left">
					...
					<div class="page_link">
						<a href="home">Home</a> <a href="blog.html">알림마당</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="blog_left_sidebar">
						...
						<div id="bbpress-forums" style="margin-bottom: 80px;">
							<ul class="bbp-forums">
								<li class="bbp-header" style="text-align: left;">
									${dto.ntitle}</li>
							</ul>
						...
						<form name="form1" method='post'>
							<li class="bbp-body">
								<ul>
									<li class="bbp-forum-topic-count">
										<p style="margin: 10px;" class="dateview1">등록일 : 
											<fmt:parseDate value="${dto.nregdate}" var='trading_day' pattern="EEE MMM dd HH:mm:ss zzz yyyy" parseLocale="en-US"/>
							...
							<li class="bbp-body" style="text-align: center;">
							...
							<div class="rowTable v1 ellipsisWrap"
								style="margin-bottom: 10px;">
								<table>
									<colgroup>
										<col style="width: 100px" class="col-lg-2">
										<col style="width: 1000px;" class="col-lg-8">
										<col style="width: 100px;" class="col-lg-2">
									</colgroup>
									<tbody>

										<tr>
											<th scope="row"><span>다음글 <img
													src="img/bl_arrow01.png" style="margin-left: 8px;"> </sapn></th>
											<c:if test="${dto.nno == 1}">
											<td><a href="notice_read?nno=2">MediSelf 홈페이지 회원 관리 정책 안내</a></td>
											<td id="next_nregdate">2020-07-07</td>
											</c:if>
											<c:if test="${dto.nno ne 1}">
											<td id="after_ncontent">다음글이 없습니다.</td>
											<td class="tr"></td>
											</c:if>
										</tr>
										<tr>
											<th scope="row"><span>이전글 <img
													src="img/bl_arrow02.png" style="margin-left: 8px;">
											</span></th>
											<c:if test="${dto.nno == 1}">
											<td>이전글이 없습니다.</td>
											<td id="next_nregdate"></td>
											</c:if>
											<c:if test="${dto.nno ne 1}">
											<td><a href="notice_read?nno=1">홈페이지 일시중단 안내</a></td>
											<td id="next_nregdate">2020-06-16</td>
											</c:if>
										</tr>
									</tbody>
								</table>
							...
							<p class="inputArea" style="text-align: right;">
								...
								<a href="notice#here" id="insertSatisfaction">목록</a>
							</p>
							</form>
						</div>
					</div>
	...
	<script src="js/notice_delete.js"></script>
</body>
