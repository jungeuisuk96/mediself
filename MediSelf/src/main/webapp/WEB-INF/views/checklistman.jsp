...
<body>
	...
	<section class="procedure_category section_gap_custom">
		...
		<div
			...
			<div class="main-container container"
				style="min-height: 450px; max-width: 970px;">
				...
				<div class="form has-side-menu">
					<div class="form-content has-footer">
						<div class="screen-container">
							<div class="screen screen-sex"
								style="position: relative; white-space: normal; height: 425px;">
								<div class="screen-content"
									style="text-align: center; position: relative; width: 100%;">
									<p id="bodycheck_title">해당 하는 항목에 선택해주세요.</p>
									<form name="screenform"
										style="display: block; margin-top: 100px; margin-bottom: 50px; margin-left: 6%; margin-right: 6%; font-size: 17px">
										<table class="checktb">
											<tr class="checktr">
												<td class="questiontd">
													<p id="question">나는 뚱뚱하거나 과체중입니다</p>
												</td>
												<td class="answertd"><input type="radio" id="oyes"
													name="obesity" value="obesity" onclick="check_click()"><label for="oyes">네</label>
													<input type="radio" id="ono" name="obesity" value="" onclick="check_click()"><label
													for="ono">아니요</label> <input type="radio" id="oknow"
													name="obesity" value="" onclick="check_click()"><label for="oknow">잘모르겠어요</label>
												</td>
											</tr>
											<tr class="checktr">
												<td class="questiontd">
													<p id="question">나는 흡연자입니다</p>
												</td>
												<td class="answertd"><input type="radio" id="syes"
													name="smoke" value="smoke" onclick="check_click()"><label for="syes">네</label>
													<input type="radio" id="sno" name="smoke" value="" onclick="check_click()"><label
													for="sno">아니요</label> <input type="radio" id="sknow"
													name="smoke" value="" onclick="check_click()"><label for="sknow">잘모르겠어요</label>
												</td>
											</tr>
											<tr class="checktr">
												<td class="questiontd">
													<p id="question">나는 최근에 다친적이 있습니다</p>
												</td>
												<td class="answertd"><input type="radio" id="hyes"
													name="heart" value="heart"onclick="check_click()"><label for="hyes">네</label>
													<input type="radio" id="hno" name="heart" value="" onclick="check_click()"><label
													for="hno">아니요</label> <input type="radio" id="hknow"
													name="heart" value="" onclick="check_click()"><label for="hknow">잘모르겠어요</label>
												</td>
											</tr>
											<tr class="checktr">
												<td class="questiontd">
													<p id="question">나는 콜레스트롤 수치가 높습니다</p>
												</td>
												<td class="answertd"><input type="radio" name="colest"
													value="colest" onclick="check_click()" id="cyes"><label for="cyes">네</label> <input
													type="radio" name="colest" value="" onclick="check_click()" id="cno"><label
													for="cno">아니요</label> <input type="radio" name="colest"
													value="" onclick="check_click()" id="cknow"><label for="cknow">잘모르겠어요</label></td>
											</tr>
											<tr class="checktr">
												<td class="questiontd">
													<p id="question">나는 고혈압을 가지고 있습니다</p>
												</td>
												<td class="answertd"><input type="radio" id="hiyes"
													name="high" value="high" onclick="check_click()"><label for="hiyes">네</label>
													<input type="radio" id="hino" name="high" value=""  onclick="check_click()"><label
													for="hino">아니요</label> <input type="radio" id="hiknow"
													name="high" value="" onclick="check_click()"><label for="hiknow">잘모르겠어요</label>
												</td>
											</tr>
											<tr class="checktr">
												<td class="questiontd">
													<p id="question">나는 당뇨병을 가지고 있습니다</p>
												</td>
												<td class="answertd"><input type="radio" id="dyes"
													name="diabetes" value="male" onclick="check_click()"><label for="dyes">네</label>
													<input type="radio" id="dno" name="diabetes" value=""  onclick="check_click()"><label
													for="dno">아니요</label> <input type="radio" id="dknow"
													name="diabetes" value="" onclick="check_click()"><label for="dknow">잘모르겠어요</label>
												</td>
											</tr>
										</table>
									</form>
					...
					<div class="footer-content"
						...
						<hr>
						<a href="age#here"><button type="button"
								style="float: left;" class="newbtn btn1">이전</button></a> <a
							href="bodycheck?#here"><button type="button"
	...
	function check_click(){
		var check = true;
		if(!$("input:radio[name='obesity']").is(":checked")){
			check = false;
		}
		if(!$("input:radio[name='smoke']").is(":checked")){
			check = false;
		}

		if(!$("input:radio[name='heart']").is(":checked")){
			check = false;
		}

		if(!$("input:radio[name='colest']").is(":checked")){
			check = false;
		}
		if(!$("input:radio[name='high']").is(":checked")){
			check = false;
		}
		if(!$("input:radio[name='diabetes']").is(":checked")){
			check = false;
		}
