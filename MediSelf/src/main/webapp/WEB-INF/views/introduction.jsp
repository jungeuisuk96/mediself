					...
					<div class="form-content has-footer"
						...
						<div class="screen-container"
							...
							<div class="screen screen-sex"
								...
								<div class="screen-content col-lg-12"
									style="text-align: center; position: relative; width: 100%;">
									<div class="screen-text-header col-lg-5" style="text-align: right; float:right">
										<img src="img/introduction.png" style="margin-right: 15px;">
									</div>
									<div class="col-lg-7 box12" style="padding-left:10px; float:left; margin-top:100px">
										<div class="content12">
											<h4 style="text-align: left; margin-bottom: 27px;">
												<strong>안녕하세요!</strong>
											</h4>
											<p style="text-align: left; margin-bottom: 27px;">여러분의
												시간을 3분정도 투자하여 안전하고 익명의 자가진단을</p>
											<p style="text-align: left; margin-bottom: 27px;">
												진행하려고 합니다. 답변들을 면밀히 분석해 증상에 대한 발병 <br>
											</p>
											<p style="text-align: left; margin-bottom: 27px;">가능성을
												예측하고 예방법을 확인하세요.</p>
										</div>
									</div>
						...
						<div class="footer-content"
							...
							<hr>
							<a href="check#here"><button type="button"
									style="float: right;" class="newbtn btn1" id="checklist">
									다음</button></a>
						</div>
					</div>
				</div>
