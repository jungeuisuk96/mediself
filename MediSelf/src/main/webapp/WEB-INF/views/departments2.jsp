		...
		<div style="border: 1px solid #E6E6E6; border-radius: 15px; margin: 10% 15%; margin-bottom: 10%;">
			<div class="main-container container">
				<div class="progress-bar">
					<div class="progress" style="width: 13.1111%;">
					</div>
				</div>
				<div class="form has-side-menu">
					<div class="form-content has-footer">
							...
							<div class="screen screen-sex" style="position: relative; white-space:  normal">
								<div class="screen-content"
									...
									<div class="screen-text-header">
										<p id="bodycheck_title">성별을 선택해주세요.</p>
									</div>
									<form name="screenform"
										style="display: block; margin-top: 150px; margin-bottom: 50px;">
										<label class="male" animate-on-click="">
											<a href="checklist#here"><button type="button" value="man"
													id="gender"><img src="img/man.png" width="150px"></button></a>
										</label>
										<label class="female" animate-on-click="" style="margin-left: 30px">
											<button type="button" value="woman" id="gender"><img src="img/woman.png"
													width="150px"></button>
										</label>
									</form>
								</div>
						...
						<div class="footer-content" style="padding: 20px 30px; min-height: 85px;">
							<hr>
							<a href="check#here"><button type="button" style="float: left"
								class="newbtn btn1">
								이전</button></a>
