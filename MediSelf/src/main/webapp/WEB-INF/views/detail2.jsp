				...
				<div class="form-has-side-menu">
					<div class="form-content has-footer">
						<div class="screen-container"  style="padding:0px 10%">
							<p id="bodycheck_title" style="text-align: center">배의 어느부분이 아프신가요?</p>
											...
											<table class="checktb">
												<tr class="checktr">
													<td class="questiontd">
														...
														for="aa" style="margin: 10px 5px;">전체적인 곳에서 통증이 있습니다</label>
													</td>
												</tr>
												<tr class="checktr">
													<td class="questiontd">
														...
														for="bb" style="margin: 10px 5px;">부분적인 곳에서 통증이 있습니다</label>
													</td>
												</tr>	
											</table>
										</form>
						...
						<div class="footer-content" style="padding: 20px 30px; min-height: 85px;">
							<hr>
							<a href="detail1#here"><button type="button" style="float: left" class="newbtn btn1">
									이전</button></a>
							<a href="detailcheck#here"><button type="button"
