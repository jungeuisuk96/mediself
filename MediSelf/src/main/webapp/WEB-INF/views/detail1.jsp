			...
			<div class="main-container container">
				...
				<div class="form-has-side-menu">
					<div class="form-content has-footer">
						<div class="screen-container" style="padding:0px 10%">
											...
											<table class="checktb">
												...
												<p></p>
													<td class="questiontd">
														...
														for="aa" style="margin: 10px 5px;">37°C 에서 38°C 사이입니다</label>
													</td>
													<td class="answertd">
													<p> </p>
													</td>
												...
												<p></p>
													<td class="questiontd">
														...
														for="bb"style="margin: 10px 5px;">38°C 에서 39°C 사이입니다</label>
													</td>
													<td class="answertd">
													<p> </p>
													</td>
												...
												<p></p>
													<td class="questiontd">
														...
														name="aa" value="" onclick="check_click()"><label
														for="cc"style="margin: 10px 5px;">39°C 이상입니다</label>
													</td>
													<td class="answertd">
													<p> </p>
													</td>
												...
												<p></p>
													<td class="questiontd">
														...
														name="aa" value="" onclick="check_click()"><label
														for="dd"style="margin: 10px 5px;">지금 온도를 잴수없습니다</label>
													</td>
													<td class="answertd">
													<p> </p>
													</td>
						...
						<div class="footer-content" style="padding: 20px 30px; min-height: 85px;">
							...
							<a href="detail#here"><button type="button" style="float: left" class="newbtn btn1">
									이전</button></a>
							<a href="detail2#here"><button type="button"
