...
<body>
		...
		<div style="border: 1px solid #E6E6E6; border-radius: 15px; margin: 10% 15%; margin-bottom: 10%;">
			<div class="main-container container" style="min-height: 480px; max-width: 970px;">
				<div class="progress-bar">
					<div class="progress" style="width: 61.1111%;"></div>
				</div>
				<div class="form-has-side-menu">
					...
					<div class="form-content has-footer">
						<div class="screen-container">
							...
							<div class="screen screen-sex" style="position: relative; white-space:  normal">
									...
									<form name="screenform"
										...
										<div class="saragim">
											<input type="text" id="symptom"
												style="padding-left:10px;float: left; width: 100%;color:#555B7D"
												value="증상을 적어주세요" size=40>
											<input type="submit" hidden>
										</div>
									</form>
									<div>
										<p class="mute"
											style="background-color: #f3f5f7; border-radius: 5px; padding: 70px 10px; margin-top: 20%"
											id="demo">
										</p>
									</div>
								</div>
								<div class="col-sm-5 hidden-xs" style="float: right; margin-top: 5%; margin-right: 6%">
									<div class="body-widget">
										<img src="img/body.png" usemap="#Map" class="map">
										<map name="Map" id="bodymap">
											...
											<area href="javascript:void(0);" shape="poly" class="popover"
												...
												alt="head" data-toggle="popover" data-placement="bottom"
												data-trigger="onclick" title="머리" data-content="<form><button class='btn btn-outline-primary' >두통</button><br>
                                        <button class='btn btn-outline-primary'>가래</button><br>
							...
							" alt="neck" data-toggle="popover" data-trigger="onclick" data-placement="bottom" title="목" data-content="<form><button class='btn btn-outline-primary'>목아픔</button><br>
                                        <button class='btn btn-outline-primary'>가래</button><br>
                                        <button class='btn btn-outline-primary'>목붓기</button>
                                   </form>">
                            ...
                            " alt="chest" data-toggle="popover" data-trigger="onclick" data-placement="bottom"
												title="가슴" data-content="<form><button class='btn btn-outline-primary'>가슴통</button><br>
                                        <button class='btn btn-outline-primary'>가래</button><br>
                                        <button class='btn btn-outline-primary'>목붓기</button>
                                   </form>">
											<area href="javascript:void(0);" class="popover" shape="poly"
												...
												alt="abdomen" data-toggle="popover" data-trigger="onclick"
												data-placement="bottom" title="배" data-content="<form><button class='btn btn-outline-primary'>복통</button><br>
                                        <button class='btn btn-outline-primary'>가래</button><br>
                                        <button class='btn btn-outline-primary'>목붓기</button>
                                   </form>">
                            ...
                            " alt="arm" data-toggle="popover" data-trigger="onclick" data-placement="bottom" title="팔"
												data-content="<form><button class='btn btn-outline-primary'>관절염</button><br>
                                        <button class='btn btn-outline-primary'>가래</button><br>
                                        <button class='btn btn-outline-primary'>목붓기</button>
                                   </form>">

											<area href="javascript:void(0);" class="popover" shape="poly" coords="138,225,173,238,177,236,182,238,217,225,213,202,211,187,203,190,155,190,143,188,141,203
                            " alt="waist" data-toggle="popover" data-trigger="onclick" data-placement="bottom"
												title="허리" data-content="<form><button class='btn btn-outline-primary'>허리디스크</button><br>
                                        <button class='btn btn-outline-primary'>가래</button><br>
                                        <button class='btn btn-outline-primary'>목붓기</button>
                                   </form>">

											<area href="javascript:void(0);" class="popover" shape="poly" coords="117,442,119,443,122,444,126,442,130,442,136,443,144,441,148,435,146,432,146,427,148,422,146,413,147,405,150,385,153,376,156,371,157,351,157,341,156,336,157,328,162,309,164,299,165,292,170,270,171,252,171,246,171,238,177,236,183,238,183,270,183,270,182,272,186,286,190,304,194,314,195,321,195,329,199,335,198,345,196,358,198,373,203,380,202,391,206,404,207,411,206,422,207,431,206,435,209,437,217,441,227,441,237,441,238,440,231,436,222,428,221,409,222,386,222,374,223,363,220,335,222,321,221,310,225,285,227,266,223,247,218,232,217,226,183,238,177,237,172,238,138,225,133,245,128,266,128,289,134,310,132,329,131,337,130,355,131,394,131,412,131,423,130,427,124,434,118,437
                            " alt="leg" data-toggle="popover" data-trigger="onclick" data-placement="bottom" title="다리"
												data-content="<form><button class='btn btn-outline-primary'>다리아파</button><br>
                                        <button class='btn btn-outline-primary'>가래</button><br>
                                        <button class='btn btn-outline-primary'>목붓기</button>
                                   </form>">
										</map>
						...
						<div class="footer-content" style="padding: 20px 30px; min-height: 85px;">
							...
							<a href="checklist#here"><button type="button" style="float: left"
									class="newbtn btn1">
									이전</button></a>
							<a href="detail#here"><button type="button" style="float: right" class="newbtn btn1">
									다음</button></a>
	...
	<script>
		$(document).ready(function () {
			...
			var pophead = $('[data-toggle="popover"]').popover({
				html: true,
				content: function () {
					return ""
				}
