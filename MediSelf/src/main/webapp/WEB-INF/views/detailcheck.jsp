		...
		<div style="border: 1px solid #E6E6E6; border-radius: 15px; margin: 10% 15%; margin-bottom: 10%;">
			<div class="main-container container">
				...
				<div class="side-menu-progress-bar"
					style="background-color: #cfd6dd; float: right; width: 82px; height: 4px; border-radius: 5px; margin-top: 21px; margin-right: 20px; overflow:hidden; ">
				...
				<div class="form-has-side-menu">
					<div class="form-content has-footer"
							...
							<div class="screen screen-sex" style="position: relative; white-space:  normal">
								<div class="screen-content"
									...
									<div class="screen-text-header">
										<div>
											<p id="bodycheck_title" style="margin-top: 30px;">아래 문항에 대답해 주세요</p>
											<form name="screenform"
												style="display: block; margin-top: 120px; margin-bottom: 50px; margin-left: 6%; margin-right: 6%">
												<p style="margin-bottom: 10%;font-weight: bold; font-size: 20px;">발 뒤꿈치를 땅에 부딪힐 때 배가 아프십니까?<br></p>
												<a href="result#here"><button type="button"
														style="border: none; padding: 0px;"><img
															src="img/tick.png"></button></a>
												<a href="result#here"><button type="button"
														style="border: none; padding: 0px; margin-left: 5%"><img
						...
						<div class="footer-content" style="padding: 20px 30px; min-height: 85px;">
							<hr>
							<a href="detail2#here"><button type="button" style="float: left" class="newbtn btn1">
									이전</button></a>
						</div>
					</div>
				</div>
