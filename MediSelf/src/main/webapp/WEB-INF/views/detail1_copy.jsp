				...
				<div class="form-has-side-menu">
					<div class="form-content has-footer">
						<div class="screen-container">
							<p id="bodycheck_title" style="text-align: center">체온이 몇도(°C)신가요</p>
								...
								<div class="screen-content"
									...
									<div class="screen-text-header">
										<form name="screenform"
											...
											<table class="checktb">
												<tr class="checktr" style="border-bottom: 1px solid #E7EBEE;">
													<td class="questiontd" >
														<input type="checkbox" id="oyes" name="obesity"
															value="obesity"><label for="oyes">37°C ~ 38°C 입니다</label>
														
													</td>
												</tr>
												<tr class="checktr" style="border-bottom: 1px solid #E7EBEE;">
													<td class="questiontd">
														<input type="checkbox" id="syes" name="smoke" value="smoke"><label
															for="syes">38°C ~ 39°C 입니다</label>
													</td>
												</tr>
												<tr class="checktr" style="border-bottom: 1px solid #E7EBEE;">
													<td class="questiontd">
													<input type="checkbox" id="hyes" name="heart" value="heart"><label
															for="hyes">39°C ~ 40°C 입니다</label>
													</td>
												</tr>
												<tr class="checktr" style="border-bottom: 1px solid #E7EBEE;">
													<td class="questiontd">
													<input type="checkbox" id="yyes" name="heart" value="heart"><label
															for="yyes">40°C 이상 입니다</label>
													</td>
												</tr>
												<tr class="checktr" style="border-bottom: 1px solid #E7EBEE;">
													<td class="questiontd">
													<input type="checkbox" id="zyes" name="heart" value="heart"><label
															for="zyes">체온을 잴수가 없습니다</label>
													</td>
												</tr>
											</table>
										</form>
						...
						<div class="footer-content" style="padding: 20px 30px; min-height: 85px;">
							<hr>
							<a href="detail#here"><button type="button" style="float: left" class="newbtn btn1">
									이전</button></a>
							<a href="detail2#here"><button type="button" style="float: right"
									class="newbtn btn1">
									다음</button></a>
						</div>
					</div>
