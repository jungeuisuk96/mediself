					...
					<div class="form-content has-footer">
								...
								<div class="screen-content"
									...
									<div class="screen-text-header">
										<form name="screenform"
											...
											<input  type="radio" id="ayes"
														name="aa" value="first" onclick="check_click()"><label
														for="ayes">전체적으로 아픕니다</label> <hr>
											<input  type="radio" id="ano"
														name="aa" value="" onclick="check_click()"><label
														for="ano">한부분만 아픕니다</label>
						...
						<div class="footer-content" style="padding: 20px 30px; min-height: 85px;">
							...
							<a href="detail1#here"><button type="button" style="float: left" class="newbtn btn1">
									이전</button></a>
							<a href="detailcheck#here"><button type="button" style="float: right"
									class="newbtn btn1">
									다음</button></a>
						</div>
					</div>
