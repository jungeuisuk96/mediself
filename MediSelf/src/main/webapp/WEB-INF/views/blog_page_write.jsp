...
<link
	...
	rel="stylesheet">
<link rel="stylesheet" href="css/bbpress_board_write.css">
...
<body>
	...
	<!--================Blog Area =================-->
	<a id="here"></a>
	<section class="blog_area" style="background-color: white">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="blog_left_sidebar">
						<form name="form1" method="post" action="notice_insert">
							<a id='here'></a>

							<div id="bbpress-forums" style="margin-bottom: 80px;">
								<div class="general-title text-left">
									<b>글쓰기 </b>
									<!-- <hr style="height: 5px; background-color: hsl(0, 2%, 65%);"> -->
								...
								<li class="bbp-body">
									<ul>
										<li style="margin: 2px;"><input id="board_title"
										name="ntitle"
								...
								<li class="bbp-body" style="text-align: center;">
									<ul class="topic status-publish hentry" style="border: none">
								...
								<span>
									<p class="inputArea" style="text-align: right;">
										<input id="btnSave" class="input_btn" type="button" value="작성"> <input
											class="input_btn" id="btn" type="reset" value="취소"> <a
											href="notice#here">목록</a>
									</p>
								</span>
						</form>
	...
	<script src="vendors/jquery-ui/jquery-ui.js"></script>
	<!--<script src="js/theme.js"></script> <script src="js/custom.js"></script> -->
	<!-- 게시판 작성 js -->
	...
	<script src="js/notice_sumbit.js"></script>
