...
<body>
				...
				<div class="form-has-side-menu">
					<div class="form-content has-footer">
						<div class="screen-container">
							<p id="bodycheck_title" style="text-align: center">나이를 선택해주세요</p>
							<div class="screen screen-sex"
								...
								<div class="screen-content"
									...
									<div class="screen-text-header">
										<form name="screenform" style="display: block; margin-top: 50px; margin-bottom: 50px; margin-left: 6%; margin-right: 6%; font-size: 17px;">
							        	<p>
											  <input type="text" id="amount" readonly style="border:0; color:black; font-weight:bold; font-size: 400%; text-align: center;  width: 100% ;">
										</p>
											<div id="slider-range-min" style="height:25px; border-radius:50px"></div>
							        </form>
									</div>
									</div>
								</div>
						...
						<div class="footer-content" style="padding: 20px 30px; min-height: 85px;">
							<hr>
							<a href="depart#here"><button type="button" style="float: left" class="newbtn btn1">
									이전</button></a>
							<a href="checklist#here"><button type="button" style="float: right"
									class="newbtn btn1">
									다음</button></a>
						</div>
					</div>
  ...
  $( function() {
    ...
    $(".ui-slider-range").css("background", "#3face4");
    $(".ui-slider-range").css("border-radius", "50px");
    $(".ui-slider-handle").css("height", "35px");
    $(".ui-slider-handle").css("width", "35px");
    $(".ui-slider-handle").css("border-radius", "50px")
    $(".ui-slider-handle").css("border", "1px solid #dee2e6")
    $(".ui-state-active").css("background", "#ffffff");
    $(".ui-state-active").css("border-radius", "30px");
  } );
  </script>
</body>
