$(document).ready(function () {
    ...
    if (window.location.href.includes("#contact_map")) { // keyword의 value값이 ""인지 확인
        console.log("contact");
        // 마커를 담을 배열입니다
        var markers = [];
        ...
        function addMarker(position) {
            var imageSrc =
                'img/hospital_marker.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
        ...
        function displayInfowindow(marker, place) {
            ...
            infowindow.setContent(
                '<div id="info_style">' + place.place_name + '</div>'
            );
